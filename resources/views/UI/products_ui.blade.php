<x-app-layout>
    <section class="bg-white py-8 dark:bg-gray-900 dark:text-gray-100">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <nav id="store" class="w-full z-30 top-0 px-6 py-1 bg-slate-200 dark:bg-gray-800">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                ...
                <a href="{{route('ui.product_show' ,$product->id)}}">
                    ...
                    <div class="pt-3 flex items-center justify-between">
                        ...
                        <svg class="h-6 w-6 fill-current text-gray-500 hover:text-black dark:text-gray-200 dark:hover:text-gray-600"
