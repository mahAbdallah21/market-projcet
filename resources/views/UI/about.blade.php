<section class="bg-white py-8 dark:bg-gray-900 dark:text-gray-100">
    ...
    <div class="container py-8 px-6 mx-auto">
        ...
        <a class="uppercase tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl mb-8 dark:text-gray-100 dark:hover:text-gray-400  " href="#">
        About
    </a>

        <p class="mt-8 mb-8">This template is inspired by the stunning nordic minimalist design - in particular:
            <br>
            <a class="text-gray-800 underline dark:text-gray-100 hover:text-gray-900 dark:hover:text-gray-400" href="http://savoy.nordicmade.com/" target="_blank">Savoy Theme</a> created by <a class="text-gray-800 underline hover:text-gray-900 dark:text-gray-100 dark:hover:text-gray-400" href="https://nordicmade.com/">https://nordicmade.com/</a> and <a class="text-gray-800 underline hover:text-gray-900 dark:text-gray-100 dark:hover:text-gray-400" href="http://savoy.nordicmade.com/" target="_blank">Savoy Theme</a> created by <a class="text-gray-800 underline hover:text-gray-900 dark:text-gray-100 dark:hover:text-gray-400" href="https://www.metricdesign.no/" target="_blank">https://www.metricdesign.no/</a></p>
