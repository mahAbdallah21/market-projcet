...
<div class="mt-8">
    ...
    <div class="mt-4">
        <div class="p-4 bg-white rounded-md shadow-md">
            <h2 class="text-lg text-gray-700 font-semibold capitalize">{{__('message.Edit product')}}</h2>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                    ...
                    <div class="mt-4">
                        ...
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" @error('price') is-invalid @enderror name="price"
                            value="{{old('price' , $product->price)}}" type="number">
                        @error('price')
                        <div
                            class="font-regular relative mb-4 block w-full rounded-lg bg-red-600 p-4 text-base leading-5 text-white opacity-100">
                            {{ $message }}</div>
                    ...
                    <div class="mt4">
                        ...
                        <select name="unit_type" @error('unit_type') is-invalid @enderror
                                class="text-l  font-bold rounded border-2 border-purple-700
                                 ...
                                 <option {{$product->unit_type == "piece" ? 'selected' :''}} value="piece">piece</option>
                                 <option {{$product->unit_type == "Liter" ? 'selected' :''}} value="Liter">Liter</option>
                                 <option {{$product->unit_type == "kg" ? 'selected' :''}} value="kg">kg</option>
                    ...
                    <div class="mt-4">
                        ...
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" @error('quantity') is-invalid @enderror name="quantity"
                    ...
                    <div class="">
                        ...
                        <div class="relative inline-flex w-full self-center">
                            ...
                            <select name="category_id" @error('category_id') is-invalid @enderror
                                ...
                                <option {{$id == old('category_id' , $product->category_id) ? 'selected' : ''}}
                    ...
                    <div class="flex  justify-items-center p-5 w-full">
                        <label class="inline-flex  justify-items-center p-7php">
                            <input type="checkbox" name="is_show" class="form-checkbox h-5 w-5  text-purple-700" {{$product->is_show == 1 ? 'checked' : '' }} >
